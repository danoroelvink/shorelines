function [QS,xp,yp]=wave_diffraction12(QS,x,y,S,hsbr,sphibr,phiw,x_mc,y_mc,x_hard,y_hard,n,hbr)
%% wave diffraction following Hurst Modified approach for angles, Kamphuis for Kd
if ~isempty(x_hard)
