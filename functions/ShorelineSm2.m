...
%        [QS,adt]=transport2(phic,philoc,thetacrit0,phiw,S,x,y,x_mc,y_mc,x_hard,y_hard,n,cyclic,it,s);
                ...
                elseif strcmpi(S.trform,'CERC2')
                    ...
                    philoc0=atan2(sin(phif-phiw),cos(phif-phiw));
                    [kh0,c0]=GUO2002(S.tper,S.ddeep);
                    [kh1,c1]=GUO2002(S.tper,S.dnearshore);
