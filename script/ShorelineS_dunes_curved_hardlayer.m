...
S.Cs=1e-5;                                                                 % Impact coefficient waves based on thesis M. Ghonim || very sensitive
S.runupform='Stockdon'; 

%% Dune till and volume of sand layer of dunes
S.Cstill=1e-7;                                                                 % Impact coefficient waves based on thesis M. Ghonim || very sensitive
S.perctill=50;
S.xtill=5;

%% Hard layer at coastline
S.x_sedlim=[876  433  100];       % alternative input with specifying x-coordinates of areas with sediment limitation separately, as [Nx1] separated with NaN's for different sections
S.y_sedlim=[548  932  1005];     % alternative input with specifying y-coordinates of areas with sediment limitation separately, as [Nx1] separated with NaN's for different sections
S.width_sedlim=[ 10  10  10];    % alternative input with specifying width at which transport starts to reduce for areas with sediment limitation separately, as [Nx1] separated with NaN's for different sections
