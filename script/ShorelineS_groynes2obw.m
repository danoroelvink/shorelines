...
S.fignryear=36;
S.smoothrefrac=0.5;                                                        % factor which smooths coastline angles that are used for the wave refraction from the nearshore point (tdp) to the point of breaking (br)
S.relaxationlength=2*S.ds0;
S.ld=1000;
S.video=0;
S.spit_width=50;
S.usefill=1;
...
S.trform='CERC3';
S.diffraction=1;
S.outputdir='output\groynes2obw\';
S.plotHS=6;
S.plotDIR=6;
S.plotQS=0;
S.plotUPW=0;
S.xyout=[500,0,2500,0];
